...
CREATE TABLE public.pois (
    ...
    CONSTRAINT "PoiDesc" FOREIGN KEY (descriptiontype) REFERENCES public.collections (typ) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION NOT VALID
) TABLESPACE pg_default;
ALTER TABLE public.pois OWNER to postgres;
CREATE INDEX id ON public.pois USING gist (geometry) TABLESPACE pg_default;
